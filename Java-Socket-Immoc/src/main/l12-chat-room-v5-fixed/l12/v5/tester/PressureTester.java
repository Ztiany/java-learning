...
import l12.v5.client.ServerInfo;
import l12.v5.client.TCPClient;
import l12.v5.client.UDPSearcher;
...
public class PressureTester {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File cachePath = Foo.getCacheDir("l5/client/test");
        IoContext.setup()
