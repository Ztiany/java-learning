package l8.q4.clink.impl;

import java.io.IOException;
import java.nio.channels.SocketChannel;
import java.util.concurrent.atomic.AtomicBoolean;

import l8.q4.clink.core.IoArgs;
import l8.q4.clink.core.IoProvider;
import l8.q4.clink.core.Receiver;
import l8.q4.clink.core.Sender;
import l8.q4.clink.utils.CloseUtils;
...
public class SocketChannelAdapter implements Sender, Receiver, Cloneable {
    ...
    //这个 IoArgs 其实就是 AsyncReceiveDispatcher 中的那个临时的 IoArgs。
    //TODO：这样使用以恶临时的成员变量，来保存正在接收的数据，是不好的，这样不能并发地接收包了。
    ...
    private final IoProvider.HandleOutputCallback mHandleOutputCallback = new IoProvider.HandleOutputCallback() {
        ...
        protected void canProviderOutput(Object attach) {
            ...
            listener.onStarted(ioArgs);
            try {
                //ioArgs.writeTo(mChannel) 保证一次调用，将所有数据全部写完。
