...
import l9.v3.clink.core.SendDispatcher;
import l9.v3.clink.core.SendPacket;
import l9.v3.clink.core.Sender;
...
public class AsyncSendDispatcher implements SendDispatcher {
    ...
    public void send(SendPacket packet) {
        ...
        synchronized (mQueueLock) {
            ...
            //让 AsyncPacketReader 来请求一个包，如果返回 true，则表示有数据需要发送
    ...
    private AsyncPacketReader.PacketProvider packetProvider = new AsyncPacketReader.PacketProvider() {
    ...
    private final AsyncPacketReader mAsyncPacketReader = new AsyncPacketReader(packetProvider);
