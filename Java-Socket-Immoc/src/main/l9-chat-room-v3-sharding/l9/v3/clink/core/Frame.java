...
public abstract class Frame {
    ...
    // 单帧最大容量 65535 个字节【两个字节能表示的最大长度】，即 64KB，帧最接近底层的数据，每一帧的数据量也较小。一个包由一个头帧和若干个实体帧组成。
     ...
     *
     * @param args 数据
     * @return 是否已消费完全， True 表示消费完了，无需再传递数据到 Frame 或从当前 Frame 读取数据。
     */
