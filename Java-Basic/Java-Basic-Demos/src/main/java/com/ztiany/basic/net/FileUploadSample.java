...
/**
 * 模拟浏览器文件上传，具体参考<a href="http://blog.csdn.net/lmj623565791/article/details/23781773">这篇博客</a>。<br/>
 * 注意：博客中代码有点问题，多写了一个空行。
 *
 * @author Ztiany
 */
public class FileUploadSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        files.put("file1", new File("Java-Archive-Files/img-01.jpg"));
        files.put("file2", new File("Java-Archive-Files/img-02.jpg"));
