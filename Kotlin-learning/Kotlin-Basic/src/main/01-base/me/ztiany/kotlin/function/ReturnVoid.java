...
public class ReturnVoid {
    ...
    public static void main(String[] args) {
        ...
        // 那么，Kotlin 为什么要引入 Unit 呢？一个很大的原因是函数式编程侧重于组合，尤其是很多高阶函数，在源码实现的时候都是采用泛型来实现的。然而 void在 涉及泛型的情况下会存在问题。
        ...
        // 但 Java 中是不能这么干的。无奈之下，我们只能把 Return 换成 Void，即 Function<String,Void>，由于 Void 没有实例，则返回一个 null。这种做法严格意义上讲，相当丑陋。
        ...
        /*
        Java 8 实际解决办法是通过引入Action<T>这种函数式接口来解决问题，比如：
